...
RFB.prototype = {
  ...
  next: function ()
  {
    ...
    arr = arr.concat(RFB.messages.keyEvent(0xff53, 1)); //right arrow
    arr = arr.concat(RFB.messages.keyEvent(0xffe9, 0)); //alt
    arr = arr.concat(RFB.messages.keyEvent(0xff53, 0)); //right arrow
  ...
  back: function ()
  {
    ...
    arr = arr.concat(RFB.messages.keyEvent(0xffe9, 1)); //alt
    arr = arr.concat(RFB.messages.keyEvent(0xff51, 1)); //right arrow
    arr = arr.concat(RFB.messages.keyEvent(0xffe9, 0)); //alt
    arr = arr.concat(RFB.messages.keyEvent(0xff51, 0)); //right arrow
  ...
  navigate: function (address) {
    ...
    arr = arr.concat(RFB.messages.keyEvent(0xff1b));
    this._sock.send(arr);

    arr = arr.concat(RFB.messages.keyEvent(0xffc3, 1));
    this._sock.send(arr);
    arr = arr.concat(RFB.messages.keyEvent(0xffc3, 0));
    this._sock.send(arr);


    this.sleep(2000);

    //arr = arr.concat(RFB.messages.keyEvent(0xffe3, 1));
    //arr = arr.concat(RFB.messages.keyEvent(0x0061, 1));
    //arr = arr.concat(RFB.messages.keyEvent(0xffe3, 0));
    //arr = arr.concat(RFB.messages.keyEvent(0x0061, 0));
    //this._sock.send(arr);

    //arr = arr.concat(RFB.messages.keyEvent(0xff80, 1));
    //arr = arr.concat(RFB.messages.keyEvent(0xff80, 0));
    //this._sock.send(arr);

    console.log(address);
    //this.enterText("http://");
    this.enterText(address);
  ...
  enterText: function (text) {
    for (var i = 0, len = text.length; i < len; i++) {
      var arr = [];
      arr = arr.concat(RFB.messages.keyEvent(text.charCodeAt(i), 1));
      arr = arr.concat(RFB.messages.keyEvent(text.charCodeAt(i), 0));
      this._sock.send(arr);
    }
  },
